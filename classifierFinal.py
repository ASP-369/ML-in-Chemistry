...
history=model.fit(X_train,Y_train,epochs=300,validation_split=0.33)
...
composition=[]
ele=["Na","Mg","Al","Si","K","Ca","Ba","Fe"]

for i in range(0,8):
    if i==6:
        composition.append(0)
        continue
    composition.append(float(input(f"Enter composition of:{ele[i]} ")))
